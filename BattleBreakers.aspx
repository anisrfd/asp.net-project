<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BattleBreakers.aspx.cs" Inherits="BattleBreakers" %>
 ...
 <a runat="server" href="~/RPG"><input style="margin-left:50px;margin-top:20px;color:red" class="submit" name="submit" type="submit" value="BACK"/></a>
<h1 style="margin-top:-200px">Battle Breakers</h1>
<div class="cover1">
<img style="width:1200px;
	border:50px solid #373854;
	margin-left:30px;
	margin-right:5px" src="gameImage/battle-breakers.jpg" />
<div>
<p>
