<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OcculusRift.aspx.cs" Inherits="OcculusRift" %>
...
<body style="background-image:url(back2.jpg)">
 <a runat="server" href="~/Pcperipherals"><input style="margin-left:50px;margin-top:20px;color:red" class="submit" name="submit" type="submit" value="BACK"/></a>
<h1 style="margin-top:-200px">OCCULUS RIFT
        </h1>
<div class="cover1">
<img style="width:1200px;
	border:50px solid #373854;
    margin-left:30px;
	margin-right:5px" src="gameImage/occulus.jpg" />
<div>
<p>
...
<h2 id="genre"> Genre: Pc Peripherals</h2>
