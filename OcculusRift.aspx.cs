...
public partial class OcculusRift : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        finally
        {
            con.Close();
            con.Dispose();
            Response.Redirect("~/OcculusRift.aspx");
        }
    }
}