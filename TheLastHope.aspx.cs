...
public partial class TheLastHope : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        finally
        {
            con.Close();
            con.Dispose();
            Response.Redirect("~/TheLastHope.aspx");
        }
    }
}