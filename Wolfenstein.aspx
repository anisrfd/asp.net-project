<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Wolfenstein.aspx.cs" Inherits="Wolfenstein" %>
 ...
 <a runat="server" href="~/FPS"><input style="margin-left:50px;margin-top:20px;color:red" class="submit" name="submit" type="submit" value="BACK"/></a>
<h1 style="margin-top:-200px">Wolfenstein 2</h1>
<div class="cover1">
<img style="width:1200px;
	border:50px solid #373854;
     margin-left:30px;
	margin-right:5px" src="gameImage/Wolfenstein.jpg" />" />
<div>
<p>
...
<div>
<div><h2 id="require">Minimum Requirements:<p>4gb ram,processor core i3 3rd genaration,windows 7<p></h2></div>
<div id="clear"></div>
<h2 id="price">Price: 100TK</h2>
